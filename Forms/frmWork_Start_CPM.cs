...
{
    public partial class frmWork_Stark_CPM : frmLoad
    {
        ...
        public frmWork_Stark_CPM(mdiMain tMDI)
        {
            TopLevel = false;        
            _mdiMain = tMDI;
            InitializeComponent();
        ...
        private void frmWork_Stark_CPM_Shown(object sender, EventArgs e)
        {
            try
            {
                Initialize();
        ...
        public void SerialPortClose()
        {
            try
            {
                if (serialPort1.IsOpen)
                {
                    ...
                    slog = DateTime.Now + "[frmWork_Start_CPM : SerialPortClose 시리얼 포트 끊기] : " + Serial_Port + ":" + Serial_Set;
        ...
        private void ProcessJob(string Body_Barcode)
        {
            ...
            try
            {
                ...
                if (Body_Barcode.Length == 22)
                {
                    ...
                    //////
                    slog = DateTime.Now + "[frmWork_Start_CPM-투입서열 확인 SP / 결과] :      " + EquipInfo.WORKCENTER + "/" + Body_Barcode.Substring(10, 8) + "/" + Body_Barcode.Substring(18, 4) + "/" + Body_Barcode.Substring(0, 10) + "/" + sINPUT_FLAG;
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    //////
                    ...
                    if (sINPUT_FLAG == "N")
                    {
                        ...
                        //////
                        slog = DateTime.Now + "[frmWork_Start_CPM-투입서열 아님/스키드 확인 SP/스키드] :      " + EquipInfo.WORKCENTER + "/" + EquipInfo.ROUTE_NO + "/" + sTAG_ID;
                        Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                        //////
                        ...
                        if (sTAG_ID != "")
                        {
                            ...
                            //////
                            slog = DateTime.Now + "[frmWork_Start_CPM-스키드 있음/ 투입된 스키드인지 확인 SP] :      " + EquipInfo.WORKCENTER + "/" + Body_Barcode.Substring(10, 8) + "/" + Body_Barcode.Substring(18, 4) + "/" + Body_Barcode.Substring(0, 10);
                            Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                            //////
                            ...
                            else if (ds.Tables[0].Rows.Count == 0)
                            {
                                ...
                                {
                                    //////
                                    slog = DateTime.Now + "[frmWork_Start_CPM-매칭 작업 및 중복 바디 체크 걸림] :      ";
                                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                                    //////
                        ...
                        {
                            //////
                            slog = DateTime.Now + "[frmWork_Start_CPM-투입 공정에 스키드 없음] :      ";
                            Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                            //////
                    ...
                    {
                        //////
                        slog = DateTime.Now + "[frmWork_Start_CPM-투입된 서열임] :      " + sINPUT_FLAG;
                        Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                        //////
                    ...
                    //매칭 SP          
                    if (EquipInfo.WORKCENTER =="CPM1")
                    {
                        if (EquipInfo.Virtual == false)
                        {
                            Procedure.PPC_INPUT_TRAN_CPM1(EquipInfo.WORKCENTER, EquipInfo.TR_ID, Body_Barcode);
                        }
                        else
                        {
                            Procedure.PPC_VIRTUAL_INPUT_TRAN_CPM1(EquipInfo.WORKCENTER, EquipInfo.TR_ID, Body_Barcode);
                        }
                    }
                    else
                    {
                        if (EquipInfo.Virtual == false)
                        {
                            Procedure.PPC_INPUT_TRAN_CPM2(EquipInfo.WORKCENTER, EquipInfo.TR_ID, Body_Barcode);
                        }
                        else
                        {
                            Procedure.PPC_VIRTUAL_INPUT_TRAN_CPM2(EquipInfo.WORKCENTER, EquipInfo.TR_ID, Body_Barcode);
                        }
                    }
                    //////
                    slog = DateTime.Now + "[frmWork_Start_CPM-스키드 매칭 SP] :      " + EquipInfo.WORKCENTER + "/" + EquipInfo.TR_ID + "/" + Body_Barcode;
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    //////                                       
                    ...
                    ds.Dispose();
                    //////
                    slog = DateTime.Now + "[frmWork_Start_CPM - TAG 전송 CAR,RF_VALUE] :      " + ds.Tables[0].Rows[0][0].ToString() + "/" + EquipInfo.BARCODE;
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    //////
        ...
        private bool InputMatch(string Barcode)
        {
            ...
            try
            {
                ...
                if (sTAG_ID == "")
                {
                    ...
                    //////
                    slog = DateTime.Now + "[frmWork_Start_CPM - TAG NG 보냄] :      ";
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    //////
                ...
                else if (ds.Tables[0].Rows[0]["BODY_NO"].ToString().Trim() != "")
                {
                    ...
                    /////
                    slog = DateTime.Now + "[frmWork_Start_CPM - 이미 매칭된 스키드] :      ";
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    ////
                ...
                if (ds.Tables[0].Rows.Count > 1)
                {
                    ...
                    /////
                    slog = DateTime.Now + "[frmWork_Start_CPM - 대기 작업지시 확인 (서열순서 확인)] :      ";
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    ////
                ...
                else
                {
                    ...
                    /////
                    slog = DateTime.Now + "[frmWork_Start_CPM - 스캔한 BODY와 작업할 대기BODY 불일치] :      ";
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    ////
        ...
        private void WorkFormLoad()
        {
            try
            {
                ...
                slog = DateTime.Now + "[frmWork_Start_CPM - frmWorkStart 폼 로드] :      ";
                Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
        ...
        private void btn_Bar_OK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //////
                slog = DateTime.Now + "[frmWork_Start_CPM-수동입력] :      " + txt_Barcode.Text;
                Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                //////
        ...
        private void txt_ReciveData_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_ReciveData.Text.IndexOf("\r\n") != -1)
                {
                    ...
                    //////
                    slog = DateTime.Now + "[frmWork_Start_CPM-스캐너리딩] :      " + RecieveData;
                    Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
                    //////
                    if (Scan_Flag == true)
                    {
        ...
        /// <summary>
        /// 2016.08.23 동윤재 수정 라벨 클릭 시 바코드 생성 후, SKID 매칭 => WORKSTART 화면 출력
        /// </summary>
        ...
        private void lbl_Skid_3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lbl_Skid_3.Text.Length != 0 && lbl_Skid_3.BackColor == Color.Lime)
                {
                    ...
                    {
                        slog = DateTime.Now + "[frmWork_Start_CPM - SKID 수동 매칭] : CANCEL(취소) ";
                        Global.EquipInfo.fhLog.TextFileWriteAppend(slog);
        ...
        private void frmWork_Stark_CPM_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                slog = DateTime.Now + "[frmWork_Stark_CPM_FormClosing] :      " + ex;
                Global.EquipInfo.fh_Err_Log.TextFileWriteAppend(slog);
            }
            //구문 추가 END
        }
